...
class AddonExtension extends AbstractTypeExtension
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->addAllowedTypes('prepend', array('null', 'string', 'Symfony\Component\Form\FormInterface', 'Fxp\Component\Block\BlockInterface'));
        $resolver->addAllowedTypes('append', array('null', 'string', 'Symfony\Component\Form\FormInterface', 'Fxp\Component\Block\BlockInterface'));
